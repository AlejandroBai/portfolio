...
(function () {
  ...
  function loadTranslations(lang) {
    ...
    .then(response => {
      ...
      console.log(translations); // Verifica el contenido de translations
  ...
  function updateLanguageButton(lang) {
    ...
    span.innerHTML = lang === 'es' ? 'English' : 'Español'; // Cambia el texto según el idioma
  }
  ...
  if (backButton) {
    backButton.addEventListener('click', function () {
      ...
      if (aboutContent) {
        ...
        aboutBody.classList.add('bg-white');
        aboutContent.classList.add('bg-dark');
        setTimeout(function () {
          window.location.href = 'index.html'; // Redirige y recarga la página de inicio
  ...
  if (goAboutButton) {
    goAboutButton.addEventListener('click', function () {
      const htmlBody = document.getElementById('home-body'); // El contenedor principal de la página
      const htmlContent = document.getElementById('home-page'); // El contenedor principal de la página
      if (htmlContent) {
        // Aplicar animación de salida
        // Cambiar el color de fondo
        htmlBody.style.backgroundColor = '#ffffff';
        // html.getAttribute('data-bs-theme').value = '#ffffff'
        htmlContent.classList.add('slide-out-left');
        htmlBody.style.backgroundColor = '#1a1c20';

        // Esperar que termine la animación antes de navegar
        setTimeout(function () {
          window.location.href = 'about.html'; // Redirige a la página "about"
        }, 500); // Tiempo de la animación
      }
    });
  }
  ...
  window.addEventListener('popstate', function (event) {
    console.log(event);
    window.location.href = 'index.html'; // Redirige a la página anterior
  });
  ...
  document.getElementById('go-about').addEventListener('click', function () {
    ...
    // Cambiar el color de fondo
    homePage.style.backgroundColor = '#1a1c20';
    // Aplicar animación de salida
